          ...
          showLogin ?
            <div className='form-wrapper'>
              <form onSubmit={handleSingIn}>
                <header>
                  <h2>Entre com seu número de telefone e senha</h2>
                </header>
                <main>
                  ...
                  <p>Não tem conta? Então clique <b onClick={() => setShowLogin(false)}>aqui</b></p>
                </main>
              </form>
            </div>
            :
            ...
            <div className='form-wrapper'>
              <form onSubmit={handleSingUp}>
                ...
                <main>
                  ...
                  <p>Já tem conta? Então clique <b onClick={() => setShowLogin(true)}>aqui</b></p>
                </main>
              </form>
            </div>
        }
